...
function Footer() {
    return (
        ...
        <section className='footer'>
            ...
            <p className='footer-text'>👨‍💻 Desarrollado y diseñado por Mayron</p>
            <section className="home-logos">
                <a className="footer-logo" href="https://github.com/Mayron-Castillo" target="_blank">
                    <svg viewBox="0 0 24 24" width="26" height="26" fill="#0b5981">
                ...
                <a className='footer-logo' href="https://www.linkedin.com/in/mayron-castillo/" target="_blank">
                    <svg viewBox="0 0 24 24" width="26" height="26" fill="#0b5981">
