function Footer() {
  // Footer con clase de desarrollado por mi y link directo a github y linkedin
  return (
    <>
      <hr className="border-none h-[2px] bg-[#bce6fb] w-full my-5 mt-12" />
      <section className="bg-[#f1f9fe] flex justify-between p-4">
        <p className="flex items-center text-l font-semibold opacity-70">
          👨‍💻 Desarrollado por Mayron
        </p>
        <section className="flex gap-4">
          <a href="https://github.com/Mayron-Castillo" target="_blank">
            <svg
              className="transition-all duration-300 ease-in-out hover:fill-[#083a5a]"
              viewBox="0 0 24 24"
              width="26"
              height="26"
              fill="#0b5981"
