function HomePage() {
  return (
    <section
      id="home"
      className="flex flex-col flex-wrap gap-4 pt-[6rem] px-4 md:pt-20 md:px-0 max-w-[1200px] mx-auto"
    >
      ...
      <section className="flex gap-4 flex-wrap min-h-[50px]">
        <a
          className="flex gap-2 items-center min-h-[50px] text-white bg-[#0b5981] rounded-md px-4 py-3 hover:bg-[#083a5a]"
