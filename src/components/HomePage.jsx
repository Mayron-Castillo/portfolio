function HomePage() {
    return (
        <section id='home' className='flex flex-wrap flex-col gap-6 pt-[5rem] px-4 md:pt-20 md:px-0' >
            <h1 className='text-6xl font-semibold p-4 md:p-0'>Soy Mayron Castillo</h1>
            
            <div className='flex flex-col gap-5 text-[1.25rem] text-left leading-8 tracking-wider space-x-[1px] p-4 md:p-0'>
                <p><span className='font-bold text-[#0b5981]'>Desarrollador Frontend </span> autodidacta con una gran pasión por la tecnología y el aprendizaje continuo. Actualmente, me especializo en React y JavaScript, creando interfaces modernas, optimizadas y accesibles.</p>            
