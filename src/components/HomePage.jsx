function HomePage() {
    return (
        <section id='home' className='flex flex-wrap flex-col gap-4 pt-[5rem] px-4 md:pt-20 md:px-0 max-w-[1200px] mx-auto' >
            ...
            <div className='flex flex-col gap-6 text-[1.25rem] text-left leading-8 tracking-wider p-4 md:p-0 md:max-w-[800px]'>
                <p className='md:leading-9'><span className='font-bold text-[#0b5981]'>Desarrollador Frontend </span> autodidacta con una gran pasión por la tecnología y el aprendizaje continuo. Actualmente, me especializo en <span className='font-bold text-[#0b5981]'>React y JavaScript</span>, creando interfaces modernas, optimizadas y accesibles.</p>            
                <p className='md:leading-9'>Estoy enfocado en mejorar mis habilidades para convertirme en un profesional sólido en el desarrollo frontend. Me gusta enfrentar desafíos, aprender nuevas herramientas y crear proyectos que no solo funcionen bien, sino que también brinden una excelente experiencia de usuario.</p>
            </div>

            <section className="flex gap-4 flex-wrap p-4 md:p-0">
                <a className="flex gap-2 items-center text-white bg-[#0b5981] rounded-md px-4 py-3 transition-all duration-300 ease-in-out hover:bg-[#083a5a]" href="https://github.com/Mayron-Castillo" target="_blank">
                    <svg className="w-[2rem]" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                ...
                <a className="flex gap-2 items-center text-white bg-[#0b5981] rounded-md px-4 py-3 transition-all duration-300 ease-in-out hover:bg-[#083a5a]" href="https://www.linkedin.com/in/mayron-castillo/" target="_blank">
                    <svg className="w-[2rem]" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
